...
export default function NotesLayoutClient({ children }: { children: React.ReactNode }) {
      ...
      <aside className="hidden md:flex flex-col w-64 bg-gray-800 text-white">
        ...
        <nav className="flex flex-col flex-1 p-4">
          ...
          <div className="mt-6 border-t border-gray-700 pt-4">
            ...
            <Link 
              href="/notes" 
              className="flex items-center px-3 py-2 rounded bg-gray-700"
            >
              <FiBook className="mr-2" /> Notes
            </Link>
            <Link 
              href="/history" 
              className="flex items-center px-3 py-2 rounded hover:bg-gray-700 mt-1"
            >
